...
export interface IAssetBundleFactory {
  ...
  registerBundleTypeCreator(bundleType: BundleType, creator: (options: BundleCreationOptions) => Promise<IAssetBundle>): this;
  ...
  getBundleTypeCreator(bundleType: BundleType): ((options: BundleCreationOptions) => Promise<IAssetBundle>) | null;
  ...
  createBundleFromAssets(assets: IAsset[], bundleType: BundleType, bundleId: string, bundleName: string): Promise<IAssetBundle>;
