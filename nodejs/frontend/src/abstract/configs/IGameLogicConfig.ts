...
export interface IGameLogicConfig extends IConfiguration {
  /** Game type/genre */
  readonly gameType: 'action' | 'adventure' | 'puzzle' | 'rpg' | 'strategy' | 'simulation' | 'arcade'
  ...
  getAchievement(achievementId: string): IGameLogicConfig['progression']['achievements'][string] | null
