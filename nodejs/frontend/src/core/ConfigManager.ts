    ...
    try {
      ...
      if (themeConfig) {
        ...
        logger.info(
          ...
          'unknown',
          'unknown',
          'Registered theme configuration for scene: ${sceneName}'
        );
      }
      ...
      logger.info(
        ...
        'unknown',
        'unknown',
        'Registered all configurations for scene: ${sceneName}'
      );
    } catch (error) {
      logger.error(
        'ConfigManager',
        'unknown',
        'Failed to register configurations for scene: ${sceneName}',
        error
      );
    }
  }
  ...
  public loadSceneConfigs(sceneName: string): {
    ...
    try {
      ...
      logger.info(
        'ConfigManager',
        'loadSceneConfigs',
        'Loaded configurations for scene: ${sceneName}',
        result
      );
      return result;
    } catch (error) {
      logger.error(
        'ConfigManager',
        'loadSceneConfigs',
        'Failed to load configurations for scene: ${sceneName}',
        error
      );
      return {
        logging: false,
