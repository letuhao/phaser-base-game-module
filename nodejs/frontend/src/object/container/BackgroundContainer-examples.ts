...
export function createMultiDeviceBackgroundContainer(scene: Phaser.Scene): BackgroundContainer {
  ...
  function updateBackgroundForDevice(): void {
    ...
    if (breakpoint && 'background' in breakpoint) {
      ...
      backgroundContainer.setBackgroundImage(backgroundKey, deviceProperties[deviceType as keyof typeof deviceProperties])
 ...
 */
export function createOrientationAwareBackgroundContainer(scene: Phaser.Scene): BackgroundContainer {
