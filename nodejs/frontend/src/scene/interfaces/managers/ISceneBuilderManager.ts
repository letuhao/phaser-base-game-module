...
export interface ISceneBuilderManager {
  ...
  /** Create builder */
  createBuilder(builderType: SceneBuilderType, config: any): Promise<ISceneBuilder>;

  /** Build scene */
  buildScene(builderId: string, config: ISceneConfig): Promise<Map<string, ISceneElement>>;
