...
// Enums
export { GameLogicEventType, GameLogicActionType } from './IGameLogicHandler';
...
export const GAME_LOGIC_CATEGORIES = {
  // Core game logic
  CORE_LOGIC: ['IGameLogicHandler'],

  // Button integration
  BUTTON_INTEGRATION: ['IButtonGameLogicBridge'],

  // All game logic interfaces
  ALL_GAME_LOGIC: ['IGameLogicHandler', 'IButtonGameLogicBridge'],
} as const;
