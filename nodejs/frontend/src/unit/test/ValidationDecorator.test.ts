...
describe('ValidationDecorator', () => {
  ...
  describe('Constructor and Basic Properties', () => {
    ...
    it('should return correct priority', () => {
      expect(validationDecorator.getPriority()).toBe(
        VALIDATION_CONSTANTS.RULES.MAX_VALIDATION_RULES / 2
      );
    });
  ...
  describe('Validation Rule Management', () => {
    it('should add custom validation rule', () => {
      ...
      validationDecorator.addValidationRule(
        'custom-rule',
        customValidator,
        'Result must be greater than 50'
      );
    ...
    it('should remove validation rule by name', () => {
      ...
      validationDecorator.addValidationRule(
        'removable-rule',
        customValidator,
        'Result must be greater than 200'
      );
  ...
  describe('Integration with Real Calculators', () => {
    it('should work with SizeUnitCalculator', () => {
      const sizeDecorator = new ValidationDecorator(
        'size-validation',
        'SizeValidation',
        sizeCalculator
      );
    ...
    it('should work with PositionUnitCalculator', () => {
      const positionDecorator = new ValidationDecorator(
        'position-validation',
        'PositionValidation',
        positionCalculator
      );
    ...
    it('should work with ScaleUnitCalculator', () => {
      const scaleDecorator = new ValidationDecorator(
        'scale-validation',
        'ScaleValidation',
        scaleCalculator
      );
