...
describe('TypeValidator', () => {
  ...
  describe('unit type validation', () => {
    ...
    it('should reject disallowed unit types', () => {
      ...
      expect(validator.getErrorMessage()).toBe(
        `Unit type '${UnitType.SCALE}' is not allowed. Allowed types: ${UnitType.SIZE}, ${UnitType.POSITION}`
      );
    });
  ...
  describe('dimension validation', () => {
    beforeEach(() => {
      validator = new TypeValidator('TestValidator', Object.values(UnitType), [
        Dimension.WIDTH,
        Dimension.HEIGHT,
      ]);
    });
    ...
    it('should reject disallowed dimensions', () => {
      ...
      expect(validator.getErrorMessage()).toBe(
        `Dimension '${Dimension.X}' is not allowed. Allowed dimensions: ${Dimension.WIDTH}, ${Dimension.HEIGHT}`
      );

      expect(validator.validate(yInput, mockContext)).toBe(false);
      expect(validator.getErrorMessage()).toBe(
        `Dimension '${Dimension.Y}' is not allowed. Allowed dimensions: ${Dimension.WIDTH}, ${Dimension.HEIGHT}`
      );
    });
  ...
  describe('value type validation in strict mode', () => {
    ...
    it('should reject boolean values', () => {
      ...
      expect(validator.getErrorMessage()).toBe(
        "Input value type 'boolean' is not allowed in strict mode"
      );
    ...
    it('should reject null and undefined', () => {
      ...
      expect(validator.getErrorMessage()).toBe(
        "Input value type 'object' is not allowed in strict mode"
      );

      expect(validator.validate(undefined as any, mockContext)).toBe(false);
      expect(validator.getErrorMessage()).toBe(
        "Input value type 'undefined' is not allowed in strict mode"
      );
    });
    ...
    it('should reject functions', () => {
      ...
      expect(validator.getErrorMessage()).toBe(
        "Input value type 'function' is not allowed in strict mode"
      );
    });
  });
  ...
  describe('complex validation scenarios', () => {
    beforeEach(() => {
      validator = new TypeValidator(
        'TestValidator',
        [UnitType.SIZE, UnitType.POSITION],
  ...
  describe('error message handling', () => {
    ...
    it('should provide descriptive error messages for unit type violations', () => {
      expect(validator.validate({ unitType: UnitType.POSITION } as any, mockContext)).toBe(false);
      expect(validator.getErrorMessage()).toBe(
        `Unit type '${UnitType.POSITION}' is not allowed. Allowed types: ${UnitType.SIZE}`
      );
    });
    ...
    it('should provide descriptive error messages for dimension violations', () => {
      ...
      expect(validator.getErrorMessage()).toBe(
        `Dimension '${Dimension.HEIGHT}' is not allowed. Allowed dimensions: ${Dimension.WIDTH}`
      );
    });
  ...
  describe('edge cases', () => {
    it('should handle empty allowed types array', () => {
      ...
      expect(validator.validate({ unitType: UnitType.SIZE } as any, mockContext)).toBe(false);
      expect(validator.getErrorMessage()).toBe(
        `Unit type '${UnitType.SIZE}' is not allowed. Allowed types: `
      );
    });
    ...
    it('should handle empty allowed dimensions array', () => {
      ...
      expect(validator.validate({ dimension: Dimension.WIDTH } as any, mockContext)).toBe(false);
      expect(validator.getErrorMessage()).toBe(
        `Dimension '${Dimension.WIDTH}' is not allowed. Allowed dimensions: `
      );
    });
