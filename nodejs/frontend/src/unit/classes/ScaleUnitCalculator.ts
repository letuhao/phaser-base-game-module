...
export class ScaleUnitCalculator implements IScaleUnit {
  ...
  validate(context: UnitContext): boolean {
    if (this.baseValue === ScaleValue.PARENT_SCALE || this.baseValue === ScaleValue.PARENT_WIDTH_SCALE || 
        this.baseValue === ScaleValue.PARENT_HEIGHT_SCALE) {
      return !!context.parent
    }
    if (this.baseValue === ScaleValue.SCENE_SCALE || this.baseValue === ScaleValue.SCENE_WIDTH_SCALE || 
        this.baseValue === ScaleValue.SCENE_HEIGHT_SCALE) {
      return !!context.scene
    }
    if (this.baseValue === ScaleValue.VIEWPORT_SCALE || this.baseValue === ScaleValue.VIEWPORT_WIDTH_SCALE || 
        this.baseValue === ScaleValue.VIEWPORT_HEIGHT_SCALE) {
      return !!context.viewport
    }
    if (this.baseValue === ScaleValue.CONTENT_SCALE || this.baseValue === ScaleValue.INTRINSIC_SCALE) {
