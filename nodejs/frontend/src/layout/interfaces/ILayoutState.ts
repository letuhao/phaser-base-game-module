...
import { ILayout, ILayoutConfig, ILayoutContext } from './ILayout';
import {
  ValidationSeverity,
  PerformanceLevel,
...
export interface ILayoutState {
   ...
   */
  handleAction(
    action: ILayoutStateAction,
    context: ILayoutStateContext
  ): Promise<ILayoutStateActionResult>;
...
export interface ILayoutStateManager {
   ...
   */
  transitionTo(
    targetState: ILayoutState,
    context?: Partial<ILayoutStateContext>
  ): Promise<ILayoutStateTransitionResult>;
