      ...
      if (config.hoverEffects) {
        button.on('pointerover', () => {
          ...
          if (config.hoverEffects.tint) {
            background.setFillStyle(Phaser.Display.Color.ValueToColor(config.hoverEffects.tint).color)
          }
        })
        ...
        button.on('pointerout', () => {
          ...
          if (config.hoverEffects.tint) {
            background.setFillStyle(Phaser.Display.Color.ValueToColor(config.backgroundColor || '#ffffff').color)
          }
        })
      }
